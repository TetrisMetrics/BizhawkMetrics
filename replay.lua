...
function updateControllerInputs()
  ...
  local j = replay:getFrame(n) -- TODO: not sure what n is yet
  -- TODO...also, can we call emu.setframe?
  -- TODO: call joypay.set using j
...
function updateTetriminos()
  ...
  -- somewhere in here we need to set the next tetriminos
...
while true do
  ...
  --TODO: maybe just set tetriminos and contollers here?
end
